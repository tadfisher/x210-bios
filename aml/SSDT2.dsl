 ...
 *
 * Disassembly of /tmp/fwts_tmp_table_25591_SSDT_10.dsl, Sun Feb 11 23:54:19 2018
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x0000312F (12591)
 *     Revision         0x02
 *     Checksum         0x95
 *     OEM ID           "SaSsdt"
 *     OEM Table ID     "SaSsdt "
...
DefinitionBlock ("", "SSDT", 2, "SaSsdt", "SaSsdt ", 0x00003000)
{
    ...
    External (_SB_.PCI0.LPCB.EC0_.BKLG, UnknownObj)
    External (_SB_.PCI0.LPCB.EC0_.ECFL, UnknownObj)
    ...
    OperationRegion (SANV, SystemMemory, 0x8AB5C418, 0x01F7)
    ...
    Scope (\_SB.PCI0.GFX0)
    {
        ...
        Device (DD1F)
        {
            ...
            Method (_BCM, 1, NotSerialized)  // _BCM: Brightness Control Method
            {
                ...
                {
                    Store (Arg0, \_SB.PCI0.LPCB.EC0.BKLG) /* External reference */
                }
            }
            ...
            Method (_BQC, 0, NotSerialized)  // _BQC: Brightness Query Current
            {
                If (\_SB.PCI0.LPCB.EC0.ECFL)
                {
                    Return (\_SB.PCI0.LPCB.EC0.BKLG) /* External reference */
                }
            }
        }
